...
3. Phase A independent review and mechanical readback are PASS (see gates.md, EV-A-REVIEW). V01/B01/B02/B03 are PASS on their recorded axes. Parent B03 checkpoint is next; B04/V02 are not done. Do not install dependencies yourself, fake collection with stubs, or silently fix adjacent defects. The subsequent C–F order remains independently installed package, pinned Comfy conversion, independent certification and separately approved publication.
